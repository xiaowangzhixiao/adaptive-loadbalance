...
public class UserLoadBalance implements LoadBalance {
    ...
    protected <T> Invoker<T> doSelect(List<Invoker<T>> invokers, URL url, Invocation invocation) {
        ...
        maxWeight = serverStatus.maxThreads*0.98 - serverStatus.activeConcurrent - pending*1.4
        ...
        for (int i = 1; i < len; i++) {
            ...
            double tmp = serverStatus.maxThreads*0.98 - serverStatus.activeConcurrent - pending*1.4
                    - (pending - serverStatus.lastPending) * 1.5;
            if (tmp < 0) {
                tmp = 0;
            }
